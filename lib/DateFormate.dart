...
void main() => runApp(const DateFormateApp());

class DateFormateApp extends StatelessWidget {
  const DateFormateApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(useMaterial3: true),
      home: const DateFormate(),
    );
  }
}
...
class _DateFormateState extends State<DateFormate> {
  ...
  void _onItemTapped(int index) {
    ...
    // Navigate to different pages if needed
    switch (index) {
      case 0:
      // Navigate to Home
        break;
